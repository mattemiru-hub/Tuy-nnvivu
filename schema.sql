...
ALTER TABLE programs ADD COLUMN IF NOT EXISTS theatre_badge TEXT DEFAULT 'LUCKY DRAW';
ALTER TABLE programs ADD COLUMN IF NOT EXISTS theatre_subtitle TEXT;
