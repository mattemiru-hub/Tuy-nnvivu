  ...
  en: {
    translation: {
      ...
      "setup": {
        ...
        "draw_button": "DRAW",
        "no_prizes": "OUT OF PRIZES",
        "no_eligible": "NO ELIGIBLE PEOPLE",
        "theatre_badge": "Theatre Badge",
        "theatre_subtitle": "Theatre Subtitle",
        "rules_title": "Draw Rules",
        "rules_subtitle": "Configure how winners are picked",
        "max_wins_ticket": "Max wins per Ticket",
        "max_wins_person": "Max wins per Person (UPI)",
        "priority_upgrade": "Priority level 1 upgrade",
        "priority_upgrade_desc": "If someone wins Rank #1, their previous wins are revoked and redrawn",
        "max_wins_desc": "Set to 1 for standard lucky draw",
  ...
  "vi": {
    "translation": {
      ...
      "setup": {
        ...
        "draw_button": "QUAY SỐ",
        "no_prizes": "HẾT GIẢI THƯỞNG",
        "no_eligible": "KHÔNG CÓ NGƯỜI HỢP LỆ",
        "theatre_badge": "Nhãn sân khấu (Badge)",
        "theatre_subtitle": "Phụ đề sân khấu (Subtitle)",
        "rules_title": "Quy tắc quay số",
        "rules_subtitle": "Thiết lập cách hệ thống chọn người thắng",
        "max_wins_ticket": "Số lần trúng tối đa mỗi phiếu",
        "max_wins_person": "Số lần trúng tối đa mỗi người (UPI)",
        "priority_upgrade": "Ưu tiên giải đặc biệt (Rank #1)",
        "priority_upgrade_desc": "Nếu trúng giải Rank #1, các giải đã trúng trước đó sẽ bị hủy để quay giải khác",
        "revocable_ranks": "Danh sách các Rank sẽ bị hủy (ví dụ: 5, 6)",
        "max_wins_desc": "Để là 1 cho vòng quay thông thường",
